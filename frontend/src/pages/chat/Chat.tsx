...
const Footer = ({
  ...
  const handleSendUserMessage = async () => {
      try {
          const response = await axios.post('http://192.168.137.236:7000/answer', {
              question: userInput
          }, {
              headers: {
          ...
          const answer = response.data.answer; // Assuming the API returns the answer in a property called 'answer'
          ...
          <>
            <DropdownMenu>
              ...
              <DropdownMenuContent side="top" align={'end'}>
                ...
                >
                  <Trash2Icon size={16} /> Clear messages
                </DropdownMenuItem>
                <DropdownMenuItem
                  className="flex items-center gap-2"
                  onClick={() => {
            ...
            <div className="relative flex-1">
              ...
              <Textarea
                ...
                disabled={isStream}
                value={userInput}
                placeholder={isMobileScreen ? 'Write your questions here...' : 'Write your questions here...（Shift + Enter = Newline)'}
    ...
    <div className="scroll-bar-none flex-1 overflow-y-auto overflow-x-hidden">
      <main className="m-auto w-full max-w-screen-xl overflow-auto p-4" ref={bottom}>
        {currentChatData.length === 0 && (
          <div className="flex items-center m-auto mt-2 w-fit text-center text-secondary-foreground">
          <img src="https://lizzyai.com/favicon.ico" className="h-10 w-10 rounded-full" /> 
